...
<html lang="fr">
    <head>
        ...
        <link rel="stylesheet" href="../css/pisserotte.css" />
    ...
    <body>
        <header>
            <nav id="logo">
                ...
                <div class="navbarre">
                    ...
                    <a href="#" class="blue navoptions Y">
                        Tarifs
                    </a>
                    <a href="#" class="blue navoptions X">
                        Résidence
                    </a>
                    <a href="#" class="blue navoptions Y">
                        Disponibilités
        ...
        <footer class="flex">
						...
						<h2 class="footer-heading"><a href="#" class="logo blue">GitesMontigny.com</a></h2>
						<ul class="menu flex">
							<li href="#">Accueil</li>
