				...
				<div class="col-md-12">
					<div class="wrapper">
						<div class="row mb-5">
			        		...
			        		<div class="text">
				            <p><span>Email:</span> <a href="mailto:info@yoursite.com">florence_labarre@hotmail.com</a></p>
				          </div>
			          </div>
							</div>
							<div class="col-md-3">
						...
						<div class="row no-gutters">
										...
										<div class="row text-left">
											...
											<div class="col-md-12">
												<div class="form-group text-center">
													<input type="submit" value="Message envoyé" class="btn btn-primary">
							...
							<div class="col-md-5 d-flex align-items-stretch formimg">
								<div class="info-wrap w-100 p-5 imgform">
			          </div>
							</div>
						</div>
					</div>
