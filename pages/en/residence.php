...
<div class="slider">
    <ul class="flexResi slide-track">
        ...
        <li>
            <figure>
                <img src="../../img/maison.svg" alt="A house" height="32">
                <figcaption>
                    1 gîte, 55 m²
                </figcaption>
            </figure>
        ...
        <li>
            <figure>
                <img src="../../img/personnes.svg" alt="a personnage" height="32">
                <figcaption>
                    5 peoples
                </figcaption> 
            </figure>
        ...
        <li>
            <figure>
                <img src="../../img/chambres.svg" alt="a bed" height="32">
                <figcaption>
                    2 bedrooms
                </figcaption>
            </figure>
        ...
        <li>
            <figure>
                <img src="../../img/sdb.svg" alt="a shower" height="32">
                <figcaption>
                    1 bathroom
                </figcaption>
            </figure>
...
<h2 class="reveal">The kitcher</h2>
...
<ul class="flexResi">
    <li>
        <figure>
            ...
            <figcaption>
                View of the forest and the river
            </figcaption>
        </figure>
    </li>
    <li>
